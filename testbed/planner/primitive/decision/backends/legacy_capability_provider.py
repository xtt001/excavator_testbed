...
class PrimitiveFSMCapabilityProviderConfig:
    """Static transition configuration for primitive FSM capability facts."""
...
class PrimitiveFSMCapabilityProviderPorts:
    """Live shell ports for primitive FSM transition status assembly."""
...
class PrimitiveFSMCapabilityProvider:
    ...
    def dig_transition_status(
        ...
        status = DigTransitionStatus.from_inputs(
            ...
            dig_to_carry_min_distance_to_dig_area_m=(
                config.dig_to_carry_min_distance_to_dig_area_m
            ),
            dig_to_carry_min_bucket_mass_kg=(
                config.dig_to_carry_min_bucket_mass_kg
            ),
            dig_to_carry_target_bucket_mass_kg=(
                config.dig_to_carry_target_bucket_mass_kg
            ),
            dig_to_carry_mass_plateau_enabled=(
                config.dig_to_carry_mass_plateau_enabled
            ),
            dig_to_carry_mass_plateau_min_bucket_mass_kg=(
                config.dig_to_carry_mass_plateau_min_bucket_mass_kg
            ),
            dig_to_carry_mass_plateau_hold_steps=(
                config.dig_to_carry_mass_plateau_hold_steps
            ),
            dig_to_carry_mass_plateau_min_steps=(
                config.dig_to_carry_mass_plateau_min_steps
            ),
            dump_ready_min_bucket_mass_kg=config.dump_ready_min_bucket_mass_kg,
            dig_bad_replan_enabled=config.dig_bad_replan_enabled,
            dig_bad_replan_max_steps=config.dig_bad_replan_max_steps,
            dig_bad_replan_min_bucket_mass_kg=(
                config.dig_bad_replan_min_bucket_mass_kg
            ),
            dig_exit_guard_enabled=config.dig_exit_guard_enabled,
            dig_exit_guard_min_steps=config.dig_exit_guard_min_steps,
    ...
    def carry_transition_status(
        ...
        return CarryTransitionStatus.from_inputs(
            ...
            dump_ready_hold_steps=config.dump_ready_hold_steps,
            dump_ready_min_bucket_mass_kg=config.dump_ready_min_bucket_mass_kg,
            dump_ready_min_height_above_rim_m=(
                config.dump_ready_min_height_above_rim_m
            ),
            dump_ready_require_over_footprint=(
                config.dump_ready_require_over_footprint
            ),
            dump_ready_require_clearance=config.dump_ready_require_clearance,
            dump_ready_max_horizontal_distance_m=(
                config.dump_ready_max_horizontal_distance_m
            ),
            dump_ready_position_mode=config.dump_ready_position_mode,
            ...
            dump_ready_min_dump_area_relative_x_m=(
                config.dump_ready_min_dump_area_relative_x_m
            ),
            dump_ready_max_dump_area_relative_x_m=(
                config.dump_ready_max_dump_area_relative_x_m
            ),
            dump_ready_min_dump_area_relative_z_m=(
                config.dump_ready_min_dump_area_relative_z_m
            ),
            dump_ready_max_dump_area_relative_z_m=(
                config.dump_ready_max_dump_area_relative_z_m
            ),
            dump_ready_near_window_enabled=config.dump_ready_near_window_enabled,
            dump_ready_near_window_x_tolerance_m=(
                config.dump_ready_near_window_x_tolerance_m
            ),
            dump_ready_near_window_z_tolerance_m=(
                config.dump_ready_near_window_z_tolerance_m
            ),
            dump_ready_near_window_outside_tolerance_m=(
                config.dump_ready_near_window_outside_tolerance_m
            ),
            dump_ready_near_window_require_over_footprint=(
                config.dump_ready_near_window_require_over_footprint
            ),
            dump_done_max_bucket_mass_kg=config.dump_done_max_bucket_mass_kg,
            dump_done_min_deposit_delta_kg=config.dump_done_min_deposit_delta_kg,
        )
    ...
    def dump_transition_status(
        ...
        return DumpTransitionStatus.from_inputs(
            ...
            dump_done_use_boundary_event=config.dump_done_use_boundary_event,
            ...
            dump_done_hold_steps=config.dump_done_hold_steps,
            dump_done_max_bucket_mass_kg=config.dump_done_max_bucket_mass_kg,
            dump_done_min_deposit_delta_kg=config.dump_done_min_deposit_delta_kg,
        )
    ...
    def return_transition_status(
        ...
        status = ReturnTransitionStatus.from_inputs(
            ...
            return_to_dig_start_envelope_direct_handoff_enabled=(
                config.return_to_dig_start_envelope_direct_handoff_enabled
            ),
            return_to_dig_start_envelope_gate_enabled=(
                config.return_to_dig_start_envelope_gate_enabled
            ),
            return_to_dig_shallow_guard_enabled=(
                config.return_to_dig_shallow_guard_enabled
            ),
            return_to_dig_max_bucket_mass_kg=(
                config.return_to_dig_max_bucket_mass_kg
            ),
            return_to_dig_touch_tolerance_m=(
                config.return_to_dig_touch_tolerance_m
            ),
            return_to_dig_min_depth_m=config.return_to_dig_min_depth_m,
    ...
    def _observation(self, obs: dict[str, Any]) -> PrimitiveObservationFacts:
        return PrimitiveObservationFacts.from_obs(
            obs,
            action_dim=self.ports.config.action_dim,
        )
