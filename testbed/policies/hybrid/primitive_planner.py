...
if "testbed.policies.hybrid.primitive_planner_5p" not in _sys.modules:
    from testbed.policies.hybrid.primitive_planner_5p import (
        PRIMITIVE_SKILL_IDS_5P as PRIMITIVE_SKILL_IDS_5P,
    )
    from testbed.policies.hybrid.primitive_planner_5p import (
        PRIMITIVE_SKILL_NAMES_5P as PRIMITIVE_SKILL_NAMES_5P,
    )
    from testbed.policies.hybrid.primitive_planner_5p import (
        PrimitivePlannerACT5PPolicy as PrimitivePlannerACT5PPolicy,
    )
...
def __getattr__(name: str) -> object:
    if name in {
        ...
        from testbed.policies.hybrid import primitive_planner_5p

        return getattr(primitive_planner_5p, name)
